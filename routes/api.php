...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::prefix('products')->group(function () {
            ...
            Route::post('/{variant}/glb-model', [ProductController::class, 'upload3dFile']);
            Route::post('/{variant}/model-placeholder', [ProductController::class, 'upload3dPlaceholder']);
            Route::delete('/variants/{variant}/glb-model', [UploadController::class, 'deleteVariant3dFile']);
            Route::delete('/variants/{variant}/model-placeholder', [UploadController::class, 'deleteVariant3dPlaceholder']);
